...
impl WeekTemperatures {
    pub fn new() -> Self {
        Self { temperatue: [None, None, None, None, None, None, None] }
    }

    pub fn get_temperature(&self, day: Weekday) -> Option<i32> {
        self.temperatue[day.get_day_num()]
    }

    pub fn set_temperature(&mut self, day: Weekday, temperature: i32) {
        self.temperatue[day.get_day_num()] = Some(temperature)
    }
}
